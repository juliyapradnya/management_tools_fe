<template>
  <v-main class="list">
    <h3 class="text-h3 font-weight-medium mb-5">Task User</h3>
...
export default {
  ...
  methods: {
    ...
    //read data
    readData() {
      var url = this.$api + "/showallemployeelogin";
      this.$http
        .get(url, {
          headers: {
    ...
    readDataExcludeByName(name) {
      var url = this.$api + "/listtaskexcludebytasknameuser/" + name;
      this.$http
        .get(url, {
          headers: {
            Authorization: "Bearer " + localStorage.getItem("token"),
    ...
    readDataEmployee() {
      var url = this.$api + "/showemployeelogin";
      this.$http
        .get(url, {
          headers: {
            Authorization: "Bearer " + localStorage.getItem("token"),
